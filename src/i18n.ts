...
const en: Dict = {
  ...
  'prMergeIntegration.why': () => 'Merging into integration branch is allowed only by you (click merge)',
  'prMergeIntegration.next': () => 'Click merge yourself on the PR/MR page.',
  'prMergePreview.why': () => 'Merging into preview branch is allowed only by you (click merge)',
  'prMergePreview.next': () => 'Click merge yourself on the PR/MR page.',
  ...
  'cli.wireMigrated': (v) => `${v.client}: legacy hook entry migrated → ${v.path}`,
  ...
  'cli.wireDryRunMigrated': (v) => `${v.client}: [dry-run] would migrate legacy hook → ${v.path}`,
  ...
  'cli.statusWireLegacyHint': (v) => `  ${v.client}: legacy wiring detected (pre self-anchored runner path) — re-run: gitflow-guard wire --client ${v.client} to migrate`,
...
const zh: Dict = {
  ...
  'prMergeIntegration.why': () => '合入集成(integration)分支仅允许用户亲手点合并',
  'prMergeIntegration.next': () => '请在 GitLab/GitHub 的 MR/PR 页面上由你本人点击合并',
  'prMergePreview.why': () => '合入预览(preview)分支仅允许用户亲手点合并',
  'prMergePreview.next': () => '请在 GitLab/GitHub 的 MR/PR 页面上由你本人点击合并',
  ...
  'cli.wireMigrated': (v) => `${v.client}: 旧版 hook 条目已迁移 → ${v.path}`,
  ...
  'cli.wireDryRunMigrated': (v) => `${v.client}: [dry-run] 将迁移旧版 hook → ${v.path}`,
  ...
  'cli.statusWireLegacyHint': (v) => `  ${v.client}: 检测到旧版接线(runner 路径已过时) — 重新运行 gitflow-guard wire --client ${v.client} 完成迁移`,
